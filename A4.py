...
This script contains geospatial function for various geographical calculations.
It include function to calculation the distance between two geographical points
find the midpoint of two geographical point, and check if a point lies within 
a given radius of another point .

Author: OLUSANYA OLAYINKA
Date:2024-06-22
"""
